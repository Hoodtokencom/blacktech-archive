...
|| 320 | Political Science | Government branches: Executive, Legislative, Judicial |
|| 321 | Executive | Derrell Black — decision authority, final approvals |
|| 322 | Legislative | GLM-5.1 — SOP generation, policy drafting |
|| 323 | Judicial | Qwen 1.5B-65K — security sweeps, schedule cleaning, audits |
